      ...
      <Row>
        <Col className="da-mb-16" lg={15} span={20}>
          ...
          <p className="da-p1-body">
            column.sorter support multiple to config the priority of sort
            columns. Though sorter.compare to customize compare function. You
            can also leave it empty to use the interactive only.
          </p>
        </Col>
