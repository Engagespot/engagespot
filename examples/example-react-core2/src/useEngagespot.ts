import { $notifications } from '@engagespot/core2';
import { useStore } from '@nanostores/react';

export { addNotification, removeNotification } from '@engagespot/core2';
export function useEngagespot() {
  return { notifications: useStore($notifications), isLoading: false };
}
