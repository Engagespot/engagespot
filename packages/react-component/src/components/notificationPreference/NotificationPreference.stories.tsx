...
import { NotificationPreference, NotificationPreferenceProps } from './NotificationPreference';

export default {
  title: 'Engagespot/NotificationPreference',
  component: NotificationPreference,
} as Meta;

const Template: Story<NotificationPreferenceProps> = args => (
  <NotificationPreference {...args} />
);
