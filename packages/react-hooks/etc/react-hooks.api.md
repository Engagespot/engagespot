## API Report File for "@engagespot/react-hooks"
...
import { PermissionState as PermissionState_2 } from '@engagespot/core';
...
export function useEngagespot({ apiKey, userId, formatDate, placementOptions, endPointOverride, ...options }: UseEngagespotOptions): {
    ...
    notificationPermissionState: PermissionState_2;
    scroll: {
...
export interface UseEngagespotOptions extends Options {
    // (undocumented)
    apiKey: string;
    // Warning: (ae-forgotten-export) The symbol "dateFunctions" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    formatDate?: (dateString: string, dateFns: typeof dateFunctions) => string;
    // Warning: (ae-forgotten-export) The symbol "PlacementOptions" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
