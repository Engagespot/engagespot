...
| options.userSignature             | string                                                                                                  | Required if your app has [HMAC Authentication](https://documentation.engagespot.co/docs/HMAC-authentication/enabling-HMAC-authentication.mdx) turned on. |
