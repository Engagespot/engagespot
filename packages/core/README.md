...
| options.userSignature             | string                                                                                                  | Required if your app has [HMAC Authentication](https://documentation.engagespot.co/docs/users/HMAC-authentication.mdx) turned on. |
